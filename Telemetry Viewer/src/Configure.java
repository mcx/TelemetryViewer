...
public class Configure extends JPanel {
	
	static Configure GUI = new Configure();
	...
	public void close() {
		...
		activeChart = null;
		GUI.setPreferredSize(new Dimension(0, 0));
		GUI.revalidate();
		GUI.repaint();
